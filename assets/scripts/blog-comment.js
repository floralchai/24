...
const s_stylePath = "../../assets/general_styles/cmtbox.css"
const s_formId = "1FAIpQLSfBUJOTJWwm3qbP6YYgB9zfm2R_mFxoHWgtH1odwsKb8l-yxQ"
const s_nameId = "165746782"
const s_websiteId = "15406053"
const s_textId = "336092648"
const s_pageId = "2084083789"
const s_replyId = "1833128231"
const s_sheetId = "1UL01WzAc8JdBgskQVyMbKqxJGuNqol5Ge5cxhSXMzMA"
...
const s_widgetTitle = "<img style='border:none;display:inline' src='/assets/graphics/star_s_03.gif'> Comment box"
...
const s_noCommentsText = "No one comment here yet"
...
const v_formHtml = `
    ...
    <div id="c_nameWrapper" class="c-inputWrapper">
        ...
        <input placeholder="Your Name" class="c-input c-nameInput" name="entry.${s_nameId}" id="entry.${s_nameId}" type="text" maxlength="${s_maxLengthName}" required>
    </div>
    ...
    <div id="c_textWrapper" class="c-inputWrapper">
        ...
        <textarea placeholder="Send me a comment, ideas, or anything you're feeling about this topic" class="c-input c-textInput" name="entry.${s_textId}" id="entry.${s_textId}" rows="4" cols="50"  maxlength="${s_maxLength}" required></textarea>
    </div>
